...
class AbstractScalarEnv(gym.Env):
    ...
    def __init__(self,
            min_value=0.0, min_value=1.0, num_cells=(128, 128), boundary=None, init_type="gaussian",
            init_params=None,
        ...
        self.grid = Grid2d(num_cells=num_cells, min_value=min_value, max_value=max_value,
                           num_ghosts=self.ng,
        ...
        if srca > 0.0:
            raise NotImplementedError("Random source not yet implemented for 2D Burgers.")
