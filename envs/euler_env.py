...
class WENOEulerEnv(AbstractEulerEnv, Plottable1DEnv):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.reconstruction = 'componentwise'  # TODO: add these two to args -yiwei
        self.eos_gamma = 1.4  # eos_gamma  # Gamma law EOS
    ...
    def _prep_state(self):
        ...
        for i in range(g.space.shape[0]):  # g.space is equivalent to g.u, maybe unify them later
            # TODO: check if this can be vectorized -yiwei
