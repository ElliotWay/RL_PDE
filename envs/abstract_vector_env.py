...
# TODO: make sure this is working, and then merge with AbstractScalarEnv --> AbstractPDEENv -yiwei
class AbstractVectorEnv(gym.Env):
    """
    Environment modelling an Euler equation of arbitrary dimensions.
    ...
    def __init__(self,
                 num_cells=(128, 128), num_ghosts=None, min_value=0.0, max_value=1.0, eqn_type='euler',
                 boundary=None, init_type="sod",
                 init_params=None,
